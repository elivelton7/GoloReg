        ...
        <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="p-6 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <h2 className="text-lg font-semibold">Registered Players ({filteredPlayers.length})</h2>
                            ...
                            <div key={player.id} className="p-4 flex items-center justify-between hover:bg-gray-50">
                                <div>
                                    ...
                                    <div className="text-sm text-gray-500 flex gap-2">
                                        {player.roles.includes('FIELD') && <span className="bg-green-100 text-green-700 px-2 py-0.5 rounded-full text-xs">Field</span>}
                                        {player.roles.includes('GK') && <span className="bg-orange-100 text-orange-700 px-2 py-0.5 rounded-full text-xs">GK</span>}
                                    </div>
                                </div>
                                <button
